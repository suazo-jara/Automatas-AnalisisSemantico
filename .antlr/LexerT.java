// Generated from c:\Users\maste\Documents\GitHub\Automatas-AnalisisSemantico\LexerT.g4 by ANTLR 4.9.2
...
public class LexerT extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"OR", "AND", "MAYOR", "MENOR", "EQUAL", "NOTEQUAL", "VARNAME", "CADENA", 
			"INT", "FLOAT", "WS"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			null, null, "'.'", "'acelera'", "'pasar cambio en'", "'derrapar a'", 
			"'o'", "'y'", "'distancia mayor'", "'distancia menor'", "'distancia igual'", 
			"'distancia diferente'"
		};
	}
	...
	public static final String _serializedATN =
		...
		"\"\2\u01d9\2\3\3\2\2\2\2\5\3\2\2\2\2\7\3\2\2\2\2\t\3\2\2\2\2\13\3\2\2"+
