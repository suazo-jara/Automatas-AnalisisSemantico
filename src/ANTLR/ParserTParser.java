...
public class ParserTParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "'cuando'", "'conduzca'", "'hacia'", "'mientras'", "'veces alrededor de'", 
		"'si'", "'con'", "'para llegar a'", "'que'", "'entonces'", "'realice un recorrido de'", 
		"'corte camino en'", "'tomar salida'", "'desvia en'", "'bienvenido al gps.'", 
		"'has llegado a tu destino.'", "'desde tu ubicacion actual,'", "'preferencias de ruta:'", 
		"'indicaciones de ruta:'", "ORDEN", "DIRECCION", "DISTANCIA", "SENTIDO", 
		"MEDIDA", "'.'", "'acelera'", "'pasar cambio en'", "'derrapar a'", "'o'", 
		"'y'", "'distancia mayor'", "'distancia menor'", "'distancia igual'", 
		"'distancia diferente'", "VARNAME", "CADENA", "INT", "FLOAT", "WS"
	};
	public static final int
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			{
			setState(56); match(BEGINGPS);
			setState(57); match(BEGIN);
			setState(61);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__10) | (1L << T__8) | (1L << T__6) | (1L << T__3) | (1L << T__2) | (1L << T__1) | (1L << ORDEN) | (1L << EXPONENCIAL) | (1L << COSENO) | (1L << RAIZC))) != 0)) {
				{
				{
				setState(58); instrucciones();
				}
				}
				setState(63);
				_errHandler.sync(this);
	...
	public static class InstruccionesContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ParserTListener ) ((ParserTListener)listener).enterInstrucciones(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ParserTListener ) ((ParserTListener)listener).exitInstrucciones(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public final InstruccionesContext instrucciones() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(66); instruccion();
				}
				break;
			case 2:
				{
				setState(67); instruccion();
				setState(68); operador();
				setState(69); instruccion();
				}
				break;
			case 3:
				{
	...
	public static class InstruccionContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ParserTListener ) ((ParserTListener)listener).enterInstruccion(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ParserTListener ) ((ParserTListener)listener).exitInstruccion(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public final OperacionContext operacion() throws RecognitionException {
		...
		try {
			...
			case T__3:
				{
				setState(86); multiplicacion();
				}
				break;
			case T__6:
				{
				setState(87); division();
				}
				break;
			case EXPONENCIAL:
			case COSENO:
	...
	public static class OrdenContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ParserTListener ) ((ParserTListener)listener).enterOrden(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ParserTListener ) ((ParserTListener)listener).exitOrden(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class SentidoContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ParserTListener ) ((ParserTListener)listener).enterSentido(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ParserTListener ) ((ParserTListener)listener).exitSentido(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class DistanciaContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ParserTListener ) ((ParserTListener)listener).enterDistancia(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ParserTListener ) ((ParserTListener)listener).exitDistancia(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public final ImpresionContext impresion() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(105); match(OUTPUT);
			setState(106); match(T__11);
			setState(107); match(CADENA);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final CicloContext ciclo() throws RecognitionException {
		...
		try {
			...
			case T__10:
				...
				{
				setState(110); mientras();
				}
				break;
			case ORDEN:
				enterOuterAlt(_localctx, 3);
				{
				setState(111); hacermientras();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final SiContext si() throws RecognitionException {
		...
		try {
			...
			setState(120); senlogica();
			setState(121); match(T__4);
			setState(122); instrucciones();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final MientrasContext mientras() throws RecognitionException {
		...
		try {
			...
			setState(125); senlogica();
			setState(126); match(T__12);
			setState(127); instrucciones();
			setState(131);
			_errHandler.sync(this);
	...
	public static class HacermientrasContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ParserTListener ) ((ParserTListener)listener).enterHacermientras(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ParserTListener ) ((ParserTListener)listener).exitHacermientras(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public final HacermientrasContext hacermientras() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(134); instruccion();
			setState(135); match(T__13);
			setState(136); senlogica();
			setState(140);
			_errHandler.sync(this);
	...
	public final MayorContext mayor() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(157); match(MAYOR);
			setState(158); match(T__5);
			setState(159); match(INT);
			setState(160); match(MEDIDA);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final MenorContext menor() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(162); match(MENOR);
			setState(163); match(T__5);
			setState(164); match(INT);
			setState(165); match(MEDIDA);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final DistintoContext distinto() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(172); match(NOTEQUAL);
			setState(173); match(T__5);
			setState(174); match(INT);
			setState(175); match(MEDIDA);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static class ExpContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ParserTListener ) ((ParserTListener)listener).enterExp(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ParserTListener ) ((ParserTListener)listener).exitExp(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public final ExpContext exp() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(197); match(EXPONENCIAL);
			setState(198);
			_la = _input.LA(1);
			if ( !(_la==INT || _la==FLOAT) ) {
			_errHandler.recoverInline(this);
	...
	public static final String _serializedATN =
		...
		"\3\2\'(\u00ca\2:\3\2\2\2\4K\3\2\2\2\6M\3\2\2\2\b[\3\2\2\2\n]\3\2\2\2\f"+
		"_\3\2\2\2\16a\3\2\2\2\20c\3\2\2\2\22g\3\2\2\2\24k\3\2\2\2\26r\3\2\2\2"+
		"\30w\3\2\2\2\32y\3\2\2\2\34~\3\2\2\2\36\u0088\3\2\2\2 \u0091\3\2\2\2\""+
		"\u009d\3\2\2\2$\u009f\3\2\2\2&\u00a4\3\2\2\2(\u00a9\3\2\2\2*\u00ae\3\2"+
